    ...
    casper.test.begin("Mini.html notebook opening as a Anonymous user", 5, function suite(test) {
        ...
        casper.thenOpen("http://127.0.0.1:8080/mini.html?notebook=f3480ceec707f5cbc84a", function() {
            this.wait(5000);
            this.test.assertUrlMatch("http://127.0.0.1:8080/mini.html?notebook=f3480ceec707f5cbc84a");
            this.wait(5000);
