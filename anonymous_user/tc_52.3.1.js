    ...
    casper.test.begin("Shiny.html notebook opening as a Anonymous user", 5, function suite(test) {
        ...
        casper.thenOpen("http://127.0.0.1:8080/shiny.html?notebook=5078dba0b9970ca39fa8", function() {
            this.wait(2000);
            this.test.assertUrlMatch("http://127.0.0.1:8080/shiny.html?notebook=5078dba0b9970ca39fa8");
