...
casper.test.begin("CCombination of 3 cells in desired order for ex:1R Cell and 2 Markdown cells", 7, function suite(test) {
    ...
    casper.then(function(){
		this.sendKeys({type:'xpath', path:"/html/body/div[3]/div/div[2]/div/div[1]/div[3]/div[3]/div[1]/div[2]/div/div[2]/div"},input);
	});
