...
casper.test.begin("Correct R command in Help div", 4, function suite(test) {
    ...
    casper.then(function () {
        ...
        this.wait(10000);
        casper.then(function () {
            this.test.assertExists({type:'css', path:'body > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2)'},"R Documentation", "Confirmed that Help content is displayed successfully");
        });
    });
